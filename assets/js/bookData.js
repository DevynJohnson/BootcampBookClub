/* This entire file is simply exports the bookData object. This is how we can access all of the information inside.
  By using "import {bookData} from './bookData.js';" in the script.js file, we pull this entire array of objects over.
   ...
   - Description: a brief paragraph or two regarding the content of the book.
...
//function getBooks() { 
  export const bookData = [
    ...
    },
    {
      "author": "Leo Tolstoy",
      "country": "Russia",
      "description": "Acclaimed by many as the world's greatest novel, Anna Karenina provides a vast panorama of contemporary life in Russia and of humanity in general. In it Tolstoy uses his intense imaginative insight to create some of the most memorable characters in all of literature.",
